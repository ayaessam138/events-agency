...
import 'package:bookingapp/firebase/events/persentation/ui/widgets/firebase_all_events_listview_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class FirebaseAllEventsScreen extends StatelessWidget {
  const FirebaseAllEventsScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Expanded(child: FirebaseAllEventsListviewWidget()),
            ],
          ),
        ),
      ),
